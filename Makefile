...
#
# Together with a pinned Go version they make the build reproducible, which is
# what lets CI rebuild the committed binaries and assert they match their
# source. A version stamp would defeat it: writing the stamp changes the
# artifact being compared. `nv version` prints a content hash instead.
